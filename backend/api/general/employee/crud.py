...
from backend.api.general.models import Employee, EmployeeInfo

from backend.api.general.employee import schemas
from backend.api.general import models as general_models
